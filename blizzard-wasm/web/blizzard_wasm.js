/* @ts-self-types="./blizzard_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function forecast(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.forecast(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_easter_dates(start_year, end_year) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_easter_dates(start_year, end_year);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('blizzard_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
